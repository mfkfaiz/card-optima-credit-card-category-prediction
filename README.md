...
2. Conducted outlier detection and applied KNN imputation to smooth the dataset.

3. Implemented Principal Component Analysis (PCA) for dimensionality reduction and feature selection.

4. Built and compared ensemble machine learning models such as Random Forest and Gradient Boosting Classifier.

5. Used Recursive Feature Elimination (RFE) to identify the most influential predictors.
...
- The system effectively identified key behavioral indicators influencing upgrade eligibility.
